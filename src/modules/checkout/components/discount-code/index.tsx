...
const DiscountCode: React.FC<DiscountCodeProps> = ({ cart }) => {
  ...
  return (
    <div className="w-full bg-[#015464] flex flex-col">
      <div className="mb-4">
        <h3 className=" font-graphikBold text-white">Coupon</h3>
      </div>
      <div className="text-small-regular">
        {appliedDiscount ? (
          ...
          <form onSubmit={handleSubmit(onApply)} className="w-full">
            <div className="grid grid-cols-[1fr_80px] gap-x-2 text-[#fff]">
              <Input
                label="Code"
              ...
              <div>
                <Button
                  className="!min-h-[0] h-[46px] w-[80px] bg-[#7ac8b3] font-graphikBold rounded-[20px]"
                  disabled={isLoading}
                  isLoading={isLoading}
                >
                  Apply
