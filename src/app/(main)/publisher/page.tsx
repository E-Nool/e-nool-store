      ...
      <div className=" m-auto font-graphik">
        ...
        <div className="">
          ...
          <div className=" md:container  top-10   md:mx-auto flex  pt-10 md:px-2 md:flex-row flex-col justify-center items-center">
            <Image
              className=" absolute z-0 top-20 lg:w-16 md:w-10 left-0  z-[1] hidden md:block"
              src={Leaf}
              alt=""
            />
        ...
        {/*<div className=" bg-[#F9F9F9] mx-auto mt-10">*/}
        <div className=" bg-[#F9F9F9] mx-auto">
          <form
          ...
          >
            <div className=" text-center font-medium">
              ...
              <p className=" text-[#015464] text-[13px] mt-4">
                A streamlined registration form for publishers to submit essential book information.<br/> Captures key details like names, titles, contact info, and descriptions for efficient cataloging and communication.
              </p>
            </div>
              ...
              <div className="flex flex-col items-start ">
                ...
                <div className="relative mt-2 w-full flex">
                  ...
                  <input
                    ...
                    className="w-full flex-1 h-12 pl-3 rounded-md placeholder-[#b9b9b9] placeholder:text-sm"
                    name="phoneNumber"
