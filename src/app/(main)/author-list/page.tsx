  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // const authToken = await axios.post('https://admin.enool.in/user/get/authentication-user', {
        ...
        // Make the API call
        const response = await axios.get(`https://admin.enool.in/user/author-list`);
